...
class DesktopPetApp:
    ...
    def _show_context_menu(self, global_pos: QPoint):
        ...
        # Option 1: AI Face-to-Chibi conversion
        ai_action = QAction("✨ Đổi ảnh mặt (AI Gen)", menu)
    ...
    def _on_ai_gen_finished(self, success, result):
        if success:
            ...
            QMessageBox.information(
                self.overlay_window,
                "Thành công",
                "Đã tự động chuyển đổi ảnh mặt thành Mascot Chibi mới!"
            )
        else:
            QMessageBox.warning(
                self.overlay_window,
